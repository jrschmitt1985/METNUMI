...
xi = np.array([2.0, 2.5, 3.0, 4.0, 5.0])
...
print(f"Grau 4: f(3,4) = {newton(3.4):.6f}".replace('.', ','))

plt.figure(figsize=(10, 6))
plt.plot(xplot, [newton(xp) for xp in xplot], 'b-', label='Grau 4')
