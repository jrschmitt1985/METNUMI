...
plt.plot(xplot, [newton(xp) for xp in xplot], 'b-', label='Grau 2')
...
print(f"Grau 2: f(3,4) = {newton(3.4):.6f}".replace('.', ','))

plt.xlabel('x')
plt.ylabel('y')
plt.title('Newton Grau 2')
plt.legend()
plt.grid(True)

# Aplicar vírgula nos eixos
ax = plt.gca()
